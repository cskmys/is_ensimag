...
# centers-> no of clusters to return

pl = plot_data(plt, X, y)
pl.show()

""" Since there are only 2 clusters, the data is separable, hence hidden layers are not required to classify data
...
model.add(Dense(1, input_shape=(2,), activation="sigmoid"))  # adding 1st or the only layer
# 1 -> a Dense Fully Connected Layer with 1 neuron.
...
# activation="sigmoid" -> used to return 0/1, i,e, data cluster the position is predicted to belong to.
